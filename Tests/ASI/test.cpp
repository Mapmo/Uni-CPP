...
int main()
{
	...
	q12.AddOption("функционалностите, които в достатъчна степен покават практическата използваемост на сoфтуерната система", 1);
	q12.AddOption("всички функционалности на софтуерната система", -1);
	q12.AddOption("най-трудните за определяне функционалности на софтуерната система", -1);
	q12.AddOption("най-лесните за определяне функционалности на софтуерната система", -1);
	...
	q28.AddOption("Базират се на специфична нотация", 0.5);
	...
	Question q35("Върху кой модел на софтуерната система се базира подход на различни гледни точки, реализирани чрез метода SADT (структурен анализ и техника за проектиране)?");
	...
	q46.AddOption("Представят механизъм за оргранизация и структуриране на разнообразна информация", 0.5);
