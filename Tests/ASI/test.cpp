...
int main()
{
	...
	Question q2("Вярно ли е твърдението “Бизнес и потребителски изисквания са едно и
също нещо, но в различна терминология“?");
	q2.AddOption("Да", -1);
	q2.AddOption("Не", 1);
	...
	Question q4("Коя от дейностите не се извършва като част от етапа анализ на
изискванията?");
	...
	q5.AddOption("Проучване на нуждите и ограниченията на заинтересованите лица
(stakeholders)", 0.5);
	q5.AddOption("Проверка за точност и пълнота на изискванията", -1);
	q5.AddOption("Проучване на приложната област, в която ще се използва
системата", 0.5);
	q5.AddOption("Разрешаване на конфликти в изискванията", -1);
	
	Question q6("Кои от изброените не са пeрспектива при инженеринга на
изискванията?");
	...
	Question q7("Кои два аспекта първо трябва да се отчетат, когато се избира
подходяща техника за извличане на изискванията?");
	...
	Question q19("В какво се състои основната разлика между throw-away и
еволюционното прототипиране?");
	...
	Question q24("Основната концепция на моделиране на същност – връзка (entity
relationship modeling) е да:");
	...
	Question q26("Задача на предварителния преглед на документа на изискванията в
етапа на валидиране е:");
	...
	Question q47("Кои от изброените са характерни за съгранението на изисквания в база данни?");
	...
	q48.AddOption("Опише взаимодействието на данните с други външни или вътрешни обекти", 0.5);
	...
	q49.AddOption("Проверка за липсващи изисквания", -1);
	q49.AddOption("Проверка за двусмислие в изискванията", -1);
	q49.AddOption("Проверка за съгласуваност със стандартите", 1);
