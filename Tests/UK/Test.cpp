...
int main()
{
	...
	q13.AddOption("Когато всички и са изпълнени успешно", -1);
	...
	Question q33("Кои от изброените са метрики на продукт?");
	q33.AddOption("MTTF Време между две аварии", 0.5);
	q33.AddOption("Ниво на дефектите ", 0.5);
	...
	q81.AddOption("Да се осигури възможност за неформални срещи за обмен на професионално знание за методите, средствата и техниките на разработване", 0.5);
	...
	q93.AddOption("Използва се като средство да се оцени степента, до която процесът в дадена организация следва най-добрите практики", 0.5);
	q93.AddOption("Занимава се с това какви са целите, които трябва да се постигнат, а не с това как се правят нещата", -1);
	q93.AddOption("Чрез предоставяне на средства за оценяване се идентифицират слаби области в процеса, които да бъдат подобрени", 0.5);
